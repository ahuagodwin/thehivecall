...
import { CAREERS_HERO } from '@data/career.data'
      ...
      <Container className="pb-16 pt-20 md:pb-20 md:pt-24">
        ...
        <Reveal delay={0.08}>
          <h1 className="mt-6 max-w-lg font-display text-3xl font-medium leading-tight text-ink md:text-4xl">
            {CAREERS_HERO.headingPrefix}
            <span className="text-lime-dark">{CAREERS_HERO.headingAccent}</span>
            {CAREERS_HERO.headingSuffix}
          </h1>
        </Reveal>
      </Container>
